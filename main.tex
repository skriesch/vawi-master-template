...
% Angepasst für beide Universitäten von Sarah Julia Kriesch
...
% Importieren aller Voreinstellungen
\input{config.tex}
...
\usepackage[
    ...
    pdftitle={\title}, %Dateiname
    pdfauthor={\author}, %Name des Autors
    pdfcreator={\author},
    pdfsubject={\title},
    pdfkeywords={\keywords},
    pdfpagelabels=true,
    colorlinks=true, %farbige Links
    linkcolor=vawiblue, %Farbe für interne Links
    urlcolor=vawilightblue,%Farbe für externe Links
    anchorcolor=black,
    citecolor=vawiblue, %Farbe für Zitate
    filecolor=magenta,%Farbe für Datei-Links
